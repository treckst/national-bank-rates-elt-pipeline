...
# Python Azure Function (Timer-Trigger) fetches every 5min for exchange rates and gold prices.

# Raw data is stored in Azure Data Lake Storage Gen2 in the Bronze Container as partitioned Parquet files to optimize cost.
